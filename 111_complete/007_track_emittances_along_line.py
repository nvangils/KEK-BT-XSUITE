...
"""
Tracks input distribution to INJP and calculates emittance blowup along BTe
User choices: radiation ON/OFF tapering ON/OFF ECS settings and injection reference energy of line
Output: Emittance along the line showing the effect of strong horizontal bends
=============================================
