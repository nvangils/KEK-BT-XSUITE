...
Output: survival fraction within DA of HER for fixed voltage, variable lag
=============================================
...
lag_values = [170, 175, 180]         # CHOOSE ECS LAG VALUES (IN DEGREES) TO SCAN
...
######################################### Scan over lag values ###################################

##line["volt_acw"] = 100E6 #Set voltage in MeV

survival_results = []

for lag_val in lag_values:
    print(f"\n===== Running for lag = {lag_val} =====")
