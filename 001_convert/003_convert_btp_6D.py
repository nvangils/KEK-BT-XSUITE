...
SAD_LATTICE_PATH    = '../lattices/btp.sad'
...
output_path = f"{OUTPUT_DIRECTORY}/{OUTPUT_FILENAME}.json"
line.to_json(output_path)
print(f"Saved Xsuite line to: {output_path}")