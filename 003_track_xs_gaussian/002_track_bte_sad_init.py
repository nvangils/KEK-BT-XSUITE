"""
Compare tracking of BTe with ECS between SAD and Xsuite
=============================================
...
initial_dist_file       = "../out/bte_pbte.dat"
final_dist_file         = "../out/bte_injp.dat"
initial_dist_element    = "PBTE"
final_dist_element      = "INJP"
...
fig.align_labels()
fig.tight_layout()
fig.savefig("../out/003_bte_track_sad_vs_xs_initial.png", dpi = 300)
...
fig.align_labels()
fig.tight_layout()
fig.savefig("../out/003_bte_track_sad_vs_xs_final.png", dpi = 300)
...
fig.align_labels()
fig.tight_layout()
fig.savefig("../out/003_bte_track_sad_vs_xs_surviving.png", dpi = 300)
